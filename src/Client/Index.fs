    ...
    ChartJS.line
        [ line.options
              [ option.responsive true
                option.scales
                    [ scale.y [ axes.position Left; axes.title [ title.display true; title.text "test" ] ]
                      scale.yRight [ axes.position Right; axes.reverse true ] ]
        ...
        [ line.options
              [ option.responsive true
                option.scales
                    [ scale.y [ axes.position Left; axes.title [ title.display true; title.text "test" ] ]
                      scale.yRight [ axes.position Right; axes.reverse true ] ]
                option.tooltips [ tooltip.callbacks [ tooltipcallback.beforeTitle (fun (context) -> printfn "test") ] ]
                option.plugins[plugin.datalabels
                                   [ datalabels.display true
                                     datalabels.allign Bottom
                                     datalabels.borderRadius 3
